# -*- coding: utf-8 -*-
# @Time    : 2021/1/21 11:47
# @Author  : 夏宇
# @FileName: CrawlersSecondStage.py
# @Software: PyCharm
...
def run():
    PageURL = 'https://m.weibo.cn/api/container/getIndex?containerid=2304132803301701_-_WEIBO_SECOND_PROFILE_WEIBO&luicode=10000011&lfid=2310022803301701_-_HOTMBLOG&page_type=03&page='
    path = '2020.1.23-2020.2.7.xlsx'
    #1875-2070; 2020.1.23-2.7
    for page in range(1720,1874):
        print(page)
